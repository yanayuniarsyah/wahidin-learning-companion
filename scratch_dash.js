...
const rubrikSkoring = {
    ...
    'Minat': {
        ...
        function applySettings() {
            ...
            if (brandIcon) {
                if (escapedLogo) {
                    brandIcon.innerHTML = `<img src="${escapedLogo}" style="width:100%;height:100%;object-fit:contain;">`;
                    brandIcon.style.background = 'white';
                    brandIcon.style.padding = '2px';
                    brandIcon.style.width = '38px';
                    brandIcon.style.height = '38px';
                    brandIcon.style.borderRadius = '6px';
                } else {
                    brandIcon.innerHTML = `
                        <svg width="100%" height="100%" viewBox="0 0 100 45" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M10,35 C30,35 45,20 50,5 C55,20 70,35 90,35" stroke="#b38e5d" stroke-width="2.5" fill="none"/>
                            <path d="M30,30 Q50,15 70,30" stroke="#b38e5d" stroke-width="1.8" fill="none"/>
                            <circle cx="50" cy="5" r="3.5" fill="#b38e5d"/>
                            <path d="M50,15 L53,22 L60,22 L55,26 L57,33 L50,29 L43,33 L45,26 L40,22 L47,22 Z" fill="#b38e5d"/>
                        </svg>
                    `;
            ...
            if (loginIcon) {
                if (escapedLogo) {
                    loginIcon.innerHTML = `<img src="${escapedLogo}" style="width:100%;height:100%;object-fit:contain;">`;
                    loginIcon.style.background = 'white';
                    loginIcon.style.boxShadow = '0 10px 15px -3px rgba(212, 175, 55, 0.2)';
                    loginIcon.style.padding = '4px';
                    loginIcon.style.width = '90px';
                    loginIcon.style.height = '90px';
                    loginIcon.style.borderRadius = '1.5rem';
                } else {
                    loginIcon.innerHTML = `
                        <div class="wlc-crest" style="display: flex; flex-direction: column; align-items: center; justify-content: center; text-align: center;">
                            <svg width="85" height="39" viewBox="0 0 100 45" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M10,35 C30,35 45,20 50,5 C55,20 70,35 90,35" stroke="#b38e5d" stroke-width="2.5" fill="none"/>
                                <path d="M30,30 Q50,15 70,30" stroke="#b38e5d" stroke-width="1.5" fill="none"/>
                                <circle cx="50" cy="5" r="3" fill="#b38e5d"/>
                                <path d="M50,15 L53,22 L60,22 L55,26 L57,33 L50,29 L43,33 L45,26 L40,22 L47,22 Z" fill="#b38e5d"/>
                            </svg>
                            <div style="font-family: 'Playfair Display', serif; font-size: 1.2rem; font-weight: 700; letter-spacing: 3px; color: #b38e5d; margin-top: 5px; line-height: 1;">WAHIDIN</div>
                        </div>
                    `;
                    loginIcon.style.background = 'transparent';
                    loginIcon.style.boxShadow = 'none';
                    loginIcon.style.padding = '0';
                    loginIcon.style.width = 'auto';
...
window.executePrintSiswa = function() {
    ...
    window.printHtml(printContent);
                ...
                <div class="cert-page cert-snapshot">
                    <div class="cert-container">
                        ...
                        <div class="cert-header">
                            <div class="wlc-crest">
                                <svg width="60" height="28" viewBox="0 0 100 45" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M10,35 C30,35 45,20 50,5 C55,20 70,35 90,35" stroke="#b38e5d" stroke-width="2" fill="none"/>
                                    <path d="M30,30 Q50,15 70,30" stroke="#b38e5d" stroke-width="1.5" fill="none"/>
                                    <circle cx="50" cy="5" r="3" fill="#b38e5d"/>
                                    <path d="M50,15 L53,22 L60,22 L55,26 L57,33 L50,29 L43,33 L45,26 L40,22 L47,22 Z" fill="#b38e5d"/>
                                </svg>
                                <div class="crest-text-main">WAHIDIN</div>
                            </div>
                        </div>
                        
                        <div class="cert-body-snapshot">
                            <h1 class="cert-main-title">ACHIEVEMENT SNAPSHOT</h1>
                            <h2 class="cert-main-subtitle">WAHIDIN LEARNING COMPANION</h2>
                    ...
                    <div class="sponsor-footer">
                        KUMON Jl. Dr. Wahidin No. 24, Cilacap &nbsp;&bull;&nbsp; <i class="fab fa-whatsapp"></i> 0813-9233-3033 &nbsp;&bull;&nbsp; www.wlc-indonesia.com
                    </div>
                </div>
            `;
                ...
                const massHtml = `
                    ...
                    <head>
                        ...
                        <style>
                            ...
                            body { font-family: 'Poppins', sans-serif; margin: 0; padding: 0; background: #f1f5f9; color: #1e293b; }
                            
                            .cert-page { 
                                width: 297mm; height: 200mm;
                            ...
                            .cert-border-decor::before { top: -1.25mm; left: -1.25mm; border-right: none; border-bottom: none; }
                            .cert-border-decor::after { bottom: -1.25mm; right: -1.25mm; border-left: none; border-top: none; }
        ...
        window.viewSavedCert = function(id) {
            window.open(`${API_BASE}/share.html?id=${id}`, '_blank');
        };
        ...
        window.previewCertificate = async function() {
            ...
            try {
                ...
                if (res.ok) {
                    ...
                    window.open(`${API_BASE}/share.html?id=${result.id}`, '_blank');
                } else {
